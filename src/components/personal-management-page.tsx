...
const budgetCategories = [
  { category: 'Food & Dining', budgeted: 500, spent: 425, color: '#8884d8' },
  { category: 'Transportation', budgeted: 200, spent: 180, color: '#82ca9d' },
  { category: 'Entertainment', budgeted: 150, spent: 195, color: '#ffc658' },
  { category: 'Shopping', budgeted: 300, spent: 250, color: '#ff7300' },
  { category: 'Bills & Utilities', budgeted: 800, spent: 785, color: '#0088fe' },
];
...
const savingsProgress = [
  ...
  { month: 'Feb', amount: 4650 },
  { month: 'Mar', amount: 5100 },
  { month: 'Apr', amount: 5380 },
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-foreground">$10,100</div>
                <div className="flex items-center gap-1 mt-1">
              ...
              <div key={index} className="p-4 rounded-2xl glass-card border border-primary/10 hover:border-primary/30 transition-all duration-300">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-muted-foreground">${category.budgeted - category.spent} remaining</span>
                  </div>
                </div>
              </div>
            );
      ...
      <Card className="glass-card border-red-500/20">
        <CardHeader className="flex flex-row items-center justify-between pb-4">
          ...
          <div className="text-sm text-muted-foreground px-3 py-1 rounded-full glass-card border border-red-500/20">
            Min. payments: ${totalMinPayments}/month
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          {debtAccounts.map((debt, index) => (
            <div key={index} className="p-4 rounded-2xl glass-card border border-red-500/10 hover:border-red-500/30 transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="font-bold text-red-500 text-lg">${debt.balance.toLocaleString()}</span>
              </div>
              <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                <div className="p-2 rounded-xl bg-red-500/5 border border-red-500/10">
                  ...
                  <div className="font-semibold text-foreground">${debt.minPayment}/month</div>
                </div>
                <div className="p-2 rounded-xl bg-red-500/5 border border-red-500/10">
